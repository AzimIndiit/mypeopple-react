...
const paymentSchema1 = z.object({
  ...
  cvv: z.string().min(3, "CVV must be 3 digits").max(4, "CVV must be 4 digits").optional(),
...
const getCurrentSchema = (paymentMethod: "credit_debit" | "paypal" | "sepa") => {
...
const getDefaultValues = (paymentMethod: "credit_debit" | "paypal" | "sepa") => {
