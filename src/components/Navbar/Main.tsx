...
export default function AppNavbar({
  ...
  return (
    <nav className={cn("w-full bg-white flex flex-col items-center justify-between h-[70px]  ", className)}>
   

      {/* Left Side: Greeting */}
    <div className="w-full bg-white ">
  
    <div className="flex justify-between items-center w-full lg:px-4 lg:p-0  bg-white">
